    ...
    <Grid container justifyContent="center" mt={3} spacing={2}>
      ...
      <Grid container justifyContent="center" spacing={2} ml={2} mr={2}>
        <Grid item xs={12} md={4}>
          {/* CONSIDER DOING A SMALLER COMPONENT? */}
          <Paper className="about-block" elevation={10}><Typography variant="h3"><FaCanadianMapleLeaf color='red'/>Canadian Made</Typography></Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          {/* CONSIDER DOING A SMALLER COMPONENT? */}
          <Paper className="about-block" elevation={10}><Typography variant="h3"><GiSpotedFlower color="blue"/>Organic Materials</Typography></Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          {/* CONSIDER DOING A SMALLER COMPONENT? */}
          <Paper className="about-block" elevation={10}><Typography variant="h3"><FaThumbsUp color="#ffcc33" />Hand Crafted</Typography></Paper>
        </Grid>
      </Grid>
